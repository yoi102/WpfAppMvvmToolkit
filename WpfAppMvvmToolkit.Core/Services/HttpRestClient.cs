...
namespace WpfAppMvvmToolkit.Core.Services
{
    public class HttpRestClient: IHttpRestClient
    {
        ...
        ////    if (baseRequest.Parameters != null)
        ////        request.AddParameter("param", JsonConvert.SerializeObject(baseRequest.Parameters), ParameterType.RequestBody);
        ...
        //        //request.AddParameter("param", JsonConvert.SerializeObject(baseRequest.Parameters), ParameterType.RequestBody);
        //        //这几个都能用
        //        request.AddBody(JsonConvert.SerializeObject(baseRequest.Parameters));
        //        //request.AddJsonBody(JsonConvert.SerializeObject(baseRequest.Parameters));
        //        //request.AddJsonBody<object>(JsonConvert.SerializeObject(baseRequest.Parameters));
        //    }
        //    client.Options.BaseUrl = new Uri(apiUrl + baseRequest.Route);
        //    var response = await client.ExecuteAsync(request);
        //    if (response.StatusCode == System.Net.HttpStatusCode.OK)
